// Watch Later Manager functionality
let watchItems = [];
...
function getDomainName(url) {
   ...
   const domain = url.match(/(?:https?:\/\/)?(?:www\.)?([a-zA-Z0-9-]+)(?:\..+)?\/?/)[1];
...
function updateWatchList() {
   ...
   for (let i = 0; i < watchItems.length; i++) {
      ...
      html += `
                     <div class="watch-item watch-slide-in" data-watch-id="${
                       item.id
                     }">
                             ...
                             <div class="flex-grow-1">
                                 <div class="watch-info">
                                     ...
                                     <div class="rating-text">
                                         ...
                                         Rating: ${starsHtml} 
                                         <span class="badge ${getRatingBadgeClass(
                                           item.rating
                                         )} ms-2">${getRatingText(
            item.rating
          )}</span>
